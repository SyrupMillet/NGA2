...
ifeq ($(DEBUG),TRUE)
  ...
  CXXFLAGS += -Ofast -ftree-vectorize -ffast-math -funroll-loops -fomit-frame-pointer -pipe -fopenmp
  CFLAGS   += -Ofast -ftree-vectorize -ffast-math -funroll-loops -fomit-frame-pointer -pipe -fopenmp
  FFLAGS   += -Ofast -ftree-vectorize -ffast-math -funroll-loops -fomit-frame-pointer -pipe -fopenmp
  F90FLAGS += -Ofast -ftree-vectorize -ffast-math -funroll-loops -fomit-frame-pointer -pipe -fopenmp
